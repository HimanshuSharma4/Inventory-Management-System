...
class salesClass:
    def __init__(self,root):
        ...
        bill_Frame.place(x=280,y=140,width=495,height=330) #x=1040,y=110,width=495,height=500,,,,x=280,y=140,width=410,height=330
        ...
        self.bill_photo=self.bill_photo.resize((380,300),Image.Resampling.LANCZOS)
        self.bill_photo=ImageTk.PhotoImage(self.bill_photo)

        lbl_image=Label(self.root,image=self.bill_photo,bd=0)
        lbl_image.place(x=775,y=110)
        self.show()
#==================================================
    def show(self):
            del self.bill_list[:]
