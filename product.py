...
class productClass:
    def __init__(self,root):
        ...
        self.valid_qty = (self.root.register(self.validate_qty), '%P')
        self.valid_price = (self.root.register(self.validate_price), '%P')
        ...
        txt_price=Entry(product_Frame,textvariable=self.var_price,font=("goudy old style",15),bg='lightyellow',validate="key", validatecommand=self.valid_price).place(x=150,y=210,width=200)
        txt_qty=Entry(product_Frame,textvariable=self.var_qty,font=("goudy old style",15),bg='lightyellow',validate="key", validatecommand=self.valid_qty).place(x=150,y=260,width=200)
...
#===================================================================
    ...
    def validate_price(self, P):
        ...
        if P == "":
            return True
        # Count the dots to ensure no more than 1, and check if the rest are digits
